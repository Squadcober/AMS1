...
export default function FinancesPage() {
  ...
  const uploadFile = async (file: File) => {
    try {
      ...
      // Explicitly cast academyId to string and ensure it's not empty
      const academyId = String(user.academyId).trim();
      formData.append('academyId', academyId);

      console.log('Uploading with academyId:', academyId); // Debug log
  ...
  const handleAddTransaction = async (formData: any) => {
    try {
      ...
      if (selectedFile) {
        ...
        documentUrl = uploadResponse; // This will be the document ID URL
      }
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    ...
                    <DialogContent>
                      ...
                      <Button 
                        onClick={() => handleAddTransaction(newRecord)}
